...
- [x] GOV-016 Select and document the supported MCP revision and transport baseline; define `tools/list`/`tools/call` mapping, annotation derivation, authentication/origin/session posture, and the rule that MCP request IDs do not automatically equal logical `tool_call_id`. — completed 2026-08-22, commit e842e69, evidence: `docs/contracts/mcp.md`; MCP revision 2025-11-25 official transport specification
